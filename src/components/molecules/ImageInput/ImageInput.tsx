...
export default function InputImage({
  ...
  return (
    <div className={'flex flex-col items-center space-y-4' + ' ' + className}>
      <div
        className={`w-full min-h-[250px] max-h-[250px] flex items-center justify-center bg-gray-200/10 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer ${
          preview ? 'hidden' : ''
        }`}
        onClick={handleClick}
      >
