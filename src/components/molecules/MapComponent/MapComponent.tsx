...
const MapComponent: React.FC<MapComponentProps> = ({ points }) => {
  ...
  const centerPoint = pointArray.length
    ? pointArray[0]
    : { lat: 13.722591, lng: -88.862343 }; // default center if no points
  const ZoomHandler = () => {
  ...
  return (
    <MapContainer
      ...
      zoom={7}
      style={{ height: '33vh', width: '100%', borderRadius: '0.5rem' }}
    >
      <TileLayer
        ...
        <Marker
          ...
          position={
            point.lat === 0 && point.lng === 0
              ? [13.679570141533658, -89.23604988192977]
              : [point.lat, point.lng]
          }
        >
