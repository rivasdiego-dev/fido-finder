...
import { getLostPetsByOneDepartment, getLostPetsByOneMunicipality } from '../../../lib/services/stats.service';
...
export default function Stats() {
    ...
    const [departmentPoints, setDepartmentPoints] = useState<{ lat: number; lng: number; }[]>([]);
    const [municipalityPoints, setMunicipalityPoints] = useState<{ lat: number; lng: number; }[]>([]);
        ...
        <div className="flex-1 p-4 flex flex-col md:flex-row">
            ...
            <div className="flex flex-col w-full">
                ...
                <div>
                    ...
                    <Autocomplete
                        ...
                        onSelectionChange={(value) => setSelectedDepartment(value as string)}
                    >
                        {
                            selectDepartments.map((department) => {
                                return (
                                    <AutocompleteItem key={department.value} value={department.value}>
                                        {department.label}
                                    </AutocompleteItem>
                                )
                            })
            ...
            <div className="flex flex-col w-full">
                ...
                <div className='flex-1 flex flex-col md:flex-row w-full justify-evenly gap-4'>
                    <Card>
                        <CardHeader
                            className='bg-gradient-to-t w-full border border-[#202125] from-[#18181b] border-b-[#18181b] via-[#18181b] to-b-primary-900 text-xl font-quicksand tracking-wider font-medium'
                        >
                            ...
                            <div className='h-96 w-full pr-10'>
                                <ResponsiveContainer width="100%" height="100%">
                                    ...
                                    >
                                        ...
                                        />
                                        <Legend />
                                        <Bar dataKey="lost_pets_count" name='Mascotas perdidas' fill="#C3C3C3" activeBar={{ fill: '#5B9AD5' }} />
                                    </BarChart>
                                </ResponsiveContainer>
                            </div>
                        </CardBody>
